package com.joshua.loginconcept;
...
public class AuthAdapter extends FragmentStatePagerAdapter
        implements com.joshua.loginconcept.AuthFragment.Callback{

    private final AnimatedViewPager pager;
    private final SparseArray<com.joshua.loginconcept.AuthFragment> authArray;
    ...
    @Override
    public com.joshua.loginconcept.AuthFragment getItem(int position) {
        com.joshua.loginconcept.AuthFragment fragment=authArray.get(position);
        if(fragment==null){
            fragment=position!=1?new com.joshua.loginconcept.LogInFragment():new com.joshua.loginconcept.SignUpFragment();
    ...
    @Override
    public void show(com.joshua.loginconcept.AuthFragment fragment) {
    ...
    private float getPageOffsetX(com.joshua.loginconcept.AuthFragment fragment){

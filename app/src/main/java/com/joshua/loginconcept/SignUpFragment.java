...
public class SignUpFragment extends AuthFragment{
        ...
        if(view!=null){
            ...
            for(TextInputEditText editText:views){
                if(editText.getId()==R.id.password_input_edit){
                    ...
                    editText.addTextChangedListener(new com.joshua.loginconcept.TextWatcherAdapter(){
                        @Override
    ...
    public void fold() {
        ...
        com.joshua.loginconcept.TextSizeTransition sizeTransition=new com.joshua.loginconcept.TextSizeTransition();
